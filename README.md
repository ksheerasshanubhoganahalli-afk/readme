...
const ksheera = {
    ...
    stack       : ["PHP", "Python", "JavaScript", "Java", "C"],
    databases   : ["MongoDB", "MySQL", "SQL"],
    interests   : ["Full-Stack Development", "Database Optimization", "Clean Architecture"],
    contact     : {
        email    : "ksheerasshanubhoganahalli@gmail.com",
        phone    : "+91-7259297419",
        linkedin : "linkedin.com/in/ksheera-s-shanubhoganahalli"
    }
};
```
...
│     Percentage: 60.5%                                            │
│     S Nijalingappa Independent PU College                        │
│     Hosdurga, Karnataka                                          │
│     June 2020 — May 2022                                          │
│                                                                  │
│  📖 RELEVANT COURSEWORK                                           │
